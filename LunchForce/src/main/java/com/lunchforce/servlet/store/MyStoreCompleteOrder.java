...
/**
 * 완료되거나 취소된 주문 내역을 가져오는 서블릿
 */
@WebServlet("/store/MyStoreCompleteOrder")
public class MyStoreCompleteOrder extends HttpServlet {
	@Override
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		// 페이지 이동
		request.getRequestDispatcher("../store/MyStoreCompleteOrder.jsp").forward(request, response);
		return;
	}
}
